...
public class CountryCodeToRegionCodeMap {
    ...
    public static Map<Integer, List<String>> a() {
        ...
        arrayList47.add("SS");
        hashMap.put(Integer.valueOf((int) Opcodes.DIV_INT_LIT16), arrayList47);
        ArrayList arrayList48 = new ArrayList(2);
        arrayList48.add(RequestConfiguration.MAX_AD_CONTENT_RATING_MA);
        arrayList48.add("EH");
        hashMap.put(Integer.valueOf((int) Opcodes.REM_INT_LIT16), arrayList48);
        ArrayList arrayList49 = new ArrayList(1);
        arrayList49.add("DZ");
        hashMap.put(213, arrayList49);
        ArrayList arrayList50 = new ArrayList(1);
        arrayList50.add("TN");
        hashMap.put(Integer.valueOf((int) Opcodes.ADD_INT_LIT8), arrayList50);
        ArrayList arrayList51 = new ArrayList(1);
        arrayList51.add("LY");
        hashMap.put(Integer.valueOf((int) Opcodes.MUL_INT_LIT8), arrayList51);
        ArrayList arrayList52 = new ArrayList(1);
        arrayList52.add("GM");
        hashMap.put(Integer.valueOf((int) Opcodes.REM_INT_LIT8), arrayList52);
        ...
        arrayList55.add("ML");
        hashMap.put(Integer.valueOf((int) Opcodes.XOR_INT_LIT8), arrayList55);
        ArrayList arrayList56 = new ArrayList(1);
        arrayList56.add("GN");
        hashMap.put(Integer.valueOf((int) Opcodes.SHL_INT_LIT8), arrayList56);
        ArrayList arrayList57 = new ArrayList(1);
        arrayList57.add("CI");
        hashMap.put(Integer.valueOf((int) Opcodes.SHR_INT_LIT8), arrayList57);
        ArrayList arrayList58 = new ArrayList(1);
        arrayList58.add("BF");
        hashMap.put(Integer.valueOf((int) Opcodes.USHR_INT_LIT8), arrayList58);
