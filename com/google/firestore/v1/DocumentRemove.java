...
public final class DocumentRemove extends GeneratedMessageLite<DocumentRemove, Builder> implements DocumentRemoveOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<DocumentRemove, Builder> implements DocumentRemoveOrBuilder {
        ...
        public Builder addAllRemovedTargetIds(Iterable<? extends Integer> iterable) {
            f();
            ((DocumentRemove) this.f33398b).q0(iterable);
            return this;
        }

        public Builder addRemovedTargetIds(int i4) {
            f();
            ((DocumentRemove) this.f33398b).r0(i4);
            return this;
        }

        public Builder clearDocument() {
            f();
            ((DocumentRemove) this.f33398b).s0();
            return this;
        }

        public Builder clearReadTime() {
            f();
            ((DocumentRemove) this.f33398b).t0();
            return this;
        }

        public Builder clearRemovedTargetIds() {
            f();
            ((DocumentRemove) this.f33398b).u0();
            return this;
        }

        @Override // com.google.firestore.v1.DocumentRemoveOrBuilder
        public String getDocument() {
            return ((DocumentRemove) this.f33398b).getDocument();
        }

        @Override // com.google.firestore.v1.DocumentRemoveOrBuilder
        public ByteString getDocumentBytes() {
            return ((DocumentRemove) this.f33398b).getDocumentBytes();
        }

        @Override // com.google.firestore.v1.DocumentRemoveOrBuilder
        public Timestamp getReadTime() {
            return ((DocumentRemove) this.f33398b).getReadTime();
        }

        @Override // com.google.firestore.v1.DocumentRemoveOrBuilder
        public int getRemovedTargetIds(int i4) {
            return ((DocumentRemove) this.f33398b).getRemovedTargetIds(i4);
        }

        @Override // com.google.firestore.v1.DocumentRemoveOrBuilder
        public int getRemovedTargetIdsCount() {
            return ((DocumentRemove) this.f33398b).getRemovedTargetIdsCount();
        }

        @Override // com.google.firestore.v1.DocumentRemoveOrBuilder
        public List<Integer> getRemovedTargetIdsList() {
            return Collections.unmodifiableList(((DocumentRemove) this.f33398b).getRemovedTargetIdsList());
        }

        @Override // com.google.firestore.v1.DocumentRemoveOrBuilder
        public boolean hasReadTime() {
            return ((DocumentRemove) this.f33398b).hasReadTime();
        }

        public Builder mergeReadTime(Timestamp timestamp) {
            f();
            ((DocumentRemove) this.f33398b).w0(timestamp);
            return this;
        }

        public Builder setDocument(String str) {
            f();
            ((DocumentRemove) this.f33398b).x0(str);
            return this;
        }

        public Builder setDocumentBytes(ByteString byteString) {
            f();
            ((DocumentRemove) this.f33398b).y0(byteString);
            return this;
        }

        public Builder setReadTime(Timestamp timestamp) {
            f();
            ((DocumentRemove) this.f33398b).z0(timestamp);
            return this;
        }

        public Builder setRemovedTargetIds(int i4, int i5) {
            f();
            ((DocumentRemove) this.f33398b).A0(i4, i5);
            return this;
        }
        ...
        public Builder setReadTime(Timestamp.Builder builder) {
            f();
            ((DocumentRemove) this.f33398b).z0(builder.build());
            return this;
        }
    }
    ...
    static {
        ...
        GeneratedMessageLite.d0(DocumentRemove.class, documentRemove);
    }
    ...
    public static DocumentRemove parseDelimitedFrom(InputStream inputStream) throws IOException {
        return (DocumentRemove) GeneratedMessageLite.N(DEFAULT_INSTANCE, inputStream);
    }

    public static DocumentRemove parseFrom(ByteBuffer byteBuffer) throws InvalidProtocolBufferException {
        return (DocumentRemove) GeneratedMessageLite.V(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    protected final Object u(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (AnonymousClass1.f32454a[methodToInvoke.ordinal()]) {
            case 1:
                return new DocumentRemove();
            case 2:
                return new Builder(null);
            case 3:
                return GeneratedMessageLite.L(DEFAULT_INSTANCE, "\u0000\u0003\u0000\u0000\u0001\u0004\u0003\u0000\u0001\u0000\u0001Ȉ\u0002'\u0004\t", new Object[]{"document_", "removedTargetIds_", "readTime_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
    ...
    public static Builder newBuilder(DocumentRemove documentRemove) {
        return DEFAULT_INSTANCE.r(documentRemove);
    }
    ...
    public static DocumentRemove parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        return (DocumentRemove) GeneratedMessageLite.O(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }
    ...
    public static DocumentRemove parseFrom(ByteBuffer byteBuffer, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        return (DocumentRemove) GeneratedMessageLite.W(DEFAULT_INSTANCE, byteBuffer, extensionRegistryLite);
    }

    public static DocumentRemove parseFrom(ByteString byteString) throws InvalidProtocolBufferException {
        return (DocumentRemove) GeneratedMessageLite.P(DEFAULT_INSTANCE, byteString);
    }
    ...
    public static DocumentRemove parseFrom(ByteString byteString, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        return (DocumentRemove) GeneratedMessageLite.Q(DEFAULT_INSTANCE, byteString, extensionRegistryLite);
    }

    public static DocumentRemove parseFrom(byte[] bArr) throws InvalidProtocolBufferException {
        return (DocumentRemove) GeneratedMessageLite.X(DEFAULT_INSTANCE, bArr);
    }
    ...
    public static DocumentRemove parseFrom(byte[] bArr, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        return (DocumentRemove) GeneratedMessageLite.Y(DEFAULT_INSTANCE, bArr, extensionRegistryLite);
    }

    public static DocumentRemove parseFrom(InputStream inputStream) throws IOException {
        return (DocumentRemove) GeneratedMessageLite.T(DEFAULT_INSTANCE, inputStream);
    }
    ...
    public static DocumentRemove parseFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        return (DocumentRemove) GeneratedMessageLite.U(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }

    public static DocumentRemove parseFrom(CodedInputStream codedInputStream) throws IOException {
        return (DocumentRemove) GeneratedMessageLite.R(DEFAULT_INSTANCE, codedInputStream);
    }
    ...
    public static DocumentRemove parseFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        return (DocumentRemove) GeneratedMessageLite.S(DEFAULT_INSTANCE, codedInputStream, extensionRegistryLite);
    }
}
