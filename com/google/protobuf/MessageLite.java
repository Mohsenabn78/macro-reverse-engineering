...
public interface MessageLite extends MessageLiteOrBuilder {
    ...
    public interface Builder extends MessageLiteOrBuilder, Cloneable {
        ...
        Builder mergeFrom(byte[] bArr, int i4, int i5) throws InvalidProtocolBufferException;

        Builder mergeFrom(byte[] bArr, int i4, int i5, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException;
