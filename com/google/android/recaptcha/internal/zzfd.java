...
public final class zzfd extends zzff {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public /* synthetic */ zzfd(InputStream inputStream, int i4, zzfc zzfcVar) {
        super(null);
    ...
    */
    ...
    public final zzez zzw() throws IOException {
        ...
        int i5 = this.zzi;
        if (zzj <= i4 - i5 && zzj > 0) {
            zzez zzm = zzez.zzm(this.zzf, i5, zzj);
            this.zzi += zzj;
            return zzm;
        } else if (zzj != 0) {
            byte[] zzN = zzN(zzj);
    ...
    public final String zzx() throws IOException {
        ...
        if (zzj > 0) {
            ...
            int i5 = this.zzi;
            if (zzj <= i4 - i5) {
                String str = new String(this.zzf, i5, zzj, zzgw.zzb);
                this.zzi += zzj;
                return str;
            }
        }
