...
public class zziy extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        while (i4 <= size) {
            int i5 = (i4 + size) / 2;
            int compareTo2 = comparable.compareTo(((zzis) this.zzb.get(i5)).zza());
            if (compareTo2 < 0) {
                size = i5 - 1;
    ...
    public final Object zzl(int i4) {
        zzn();
        Object value = ((zzis) this.zzb.remove(i4)).getValue();
        if (!this.zzc.isEmpty()) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (zzb == zziyVar.zzb()) {
            for (int i4 = 0; i4 < zzb; i4++) {
                if (!zzg(i4).equals(zziyVar.zzg(i4))) {
                    return false;
                }
            }
            if (zzb == size) {
            ...
            return this.zzc.equals(zziyVar.zzc);
        }
        return entrySet().equals(zziyVar.entrySet());
    }
    ...
    public final int hashCode() {
        ...
        for (int i5 = 0; i5 < zzb; i5++) {
            i4 += ((zzis) this.zzb.get(i5)).hashCode();
        }
        if (this.zzc.size() > 0) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i5 = this.zza;
        if (size == i5) {
            zzis zzisVar = (zzis) this.zzb.remove(i5 - 1);
            zzm().put(zzisVar.zza(), zzisVar.getValue());
        }
        this.zzb.add(i4, new zzis(this, comparable, obj));
        return null;
    }
