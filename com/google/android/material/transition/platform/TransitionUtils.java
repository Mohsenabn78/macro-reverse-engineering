...
class TransitionUtils {
    ...
    private static final RectF f25145a = new RectF();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static ShapeAppearanceModel o(ShapeAppearanceModel shapeAppearanceModel, ShapeAppearanceModel shapeAppearanceModel2, final RectF rectF, final RectF rectF2, @FloatRange(from = 0.0d, to = 1.0d) final float f4, @FloatRange(from = 0.0d, to = 1.0d) final float f5, @FloatRange(from = 0.0d, to = 1.0d) final float f6) {
        if (f6 < f4) {
        ...
        return v(shapeAppearanceModel, shapeAppearanceModel2, rectF, new CornerSizeBinaryOperator() { // from class: com.google.android.material.transition.platform.TransitionUtils.2
            ...
            public CornerSize a(@NonNull CornerSize cornerSize, @NonNull CornerSize cornerSize2) {
                return new AbsoluteCornerSize(TransitionUtils.l(cornerSize.getCornerSize(rectF), cornerSize2.getCornerSize(rectF2), f4, f5, f6));
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean p(Transition transition, Context context, @AttrRes int i4) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean q(Transition transition, Context context, @AttrRes int i4, TimeInterpolator timeInterpolator) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean r(Transition transition, Context context, @AttrRes int i4) {
        PathMotion s3;
        if (i4 != 0 && (s3 = s(context, i4)) != null) {
            transition.setPathMotion(s3);
            return true;
        }
        return false;
    }
    ...
    @Nullable
    static PathMotion s(Context context, @AttrRes int i4) {
    ...
    private static int t(Canvas canvas, Rect rect, int i4) {
        RectF rectF = f25145a;
        rectF.set(rect);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void u(Canvas canvas, Rect rect, float f4, float f5, float f6, int i4, CanvasOperation canvasOperation) {
        if (i4 <= 0) {
            return;
        }
