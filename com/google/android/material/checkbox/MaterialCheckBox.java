...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    private static final int f23284c = R.style.Widget_MaterialComponents_CompoundButton_CheckBox;

    /* renamed from: d  reason: collision with root package name */
    private static final int[][] f23285d = {new int[]{16842910, 16842912}, new int[]{16842910, -16842912}, new int[]{-16842910, 16842912}, new int[]{-16842910, -16842912}};
    @Nullable

    /* renamed from: a  reason: collision with root package name */
    private ColorStateList f23286a;
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.f23286a == null) {
            ...
            this.f23286a = new ColorStateList(iArr, iArr2);
        }
        return this.f23286a;
    }
    ...
    protected void onAttachedToWindow() {
        ...
        if (this.f23287b && CompoundButtonCompat.getButtonTintList(this) == null) {
    ...
    */
    public MaterialCheckBox(android.content.Context r8, @androidx.annotation.Nullable android.util.AttributeSet r9, int r10) {
        /*
            r7 = this;
            int r4 = com.google.android.material.checkbox.MaterialCheckBox.f23284c
