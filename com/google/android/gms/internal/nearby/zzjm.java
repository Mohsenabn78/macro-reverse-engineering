...
public final class zzjm extends AbstractSafeParcelable {
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof zzjm) {
            ...
            if (Objects.equal(this.zza, zzjmVar.zza) && Objects.equal(Integer.valueOf(this.zzb), Integer.valueOf(zzjmVar.zzb)) && Objects.equal(this.zzc, zzjmVar.zzc) && Objects.equal(this.zzd, zzjmVar.zzd)) {
                return true;
            }
        }
        return false;
    ...
    public zzjm(@SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) int i4, @Nullable @SafeParcelable.Param(id = 3) com.google.android.gms.nearby.presence.zzi zziVar, @Nullable @SafeParcelable.Param(id = 4) com.google.android.gms.nearby.connection.zzo zzoVar) {
        this.zza = str;
        this.zzb = i4;
        this.zzc = zziVar;
        this.zzd = zzoVar;
