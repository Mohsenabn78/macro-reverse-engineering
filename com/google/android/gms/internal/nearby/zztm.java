...
public final class zztm {
    ...
    */
    public static int zza(int r5, int r6, java.math.RoundingMode r7) {
        ...
        Le:
            r5 = r5 ^ r6
            int[] r2 = com.google.android.gms.internal.nearby.zztl.zza
            int r3 = r7.ordinal()
            r2 = r2[r3]
            int r5 = r5 >> 31
            r3 = 1
        ...
        L4e:
            ...
            return r0
        L50:
            com.google.android.gms.internal.nearby.zztn.zza(r4)
        L53:
            return r0
        L54:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.nearby.zztm.zza(int, int, java.math.RoundingMode):int");
    }
    ...
    public static int zzb(int i4, RoundingMode roundingMode) {
        boolean z3;
        if (i4 > 0) {
            switch (zztl.zza[roundingMode.ordinal()]) {
                case 1:
                    if (((i4 - 1) & i4) == 0) {
                        z3 = true;
                    } else {
