...
public final class zzqh extends AbstractSafeParcelable {
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof zzqh) {
            ...
            if (Objects.equal(this.zza, zzqhVar.zza) && Objects.equal(this.zzb, zzqhVar.zzb)) {
                return true;
            }
        }
        return false;
    ...
    public zzqh(@SafeParcelable.Param(id = 1) IBinder iBinder, @SafeParcelable.Param(id = 2) zzqt zzqtVar) {
        zzpa zzoyVar;
        if (iBinder == null) {
            zzoyVar = null;
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public /* synthetic */ zzqh(zzqg zzqgVar) {
    }
}
