...
public final class zzck extends zzcm {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzck(byte[] bArr, int i4, int i5) {
        super(null);
    ...
    @Override // com.google.android.gms.internal.icing.zzcm
    public final void zzg(int i4, boolean z3) throws IOException {
        zzl(i4 << 3);
        zzj(z3 ? (byte) 1 : (byte) 0);
    }

    @Override // com.google.android.gms.internal.icing.zzcm
    public final void zzh(int i4, String str) throws IOException {
        zzl((i4 << 3) | 2);
        zzr(str);
    }

    @Override // com.google.android.gms.internal.icing.zzcm
    public final void zzi(int i4, zzcf zzcfVar) throws IOException {
        zzl((i4 << 3) | 2);
        zzl(zzcfVar.zzc());
        zzcfVar.zzf(this);
    }
    ...
    public final void zzj(byte b4) throws IOException {
        try {
            ...
            throw new zzcl(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), 1), e4);
        }
    }
    ...
    @Override // com.google.android.gms.internal.icing.zzcm
    public final void zzn(long j4) throws IOException {
        boolean z3;
        z3 = zzcm.zzc;
        if (z3 && this.zzc - this.zzd >= 10) {
            while ((j4 & (-128)) != 0) {
                ...
                int i4 = this.zzd;
                this.zzd = i4 + 1;
                zzfn.zzp(bArr, i4, (byte) ((((int) j4) & 127) | 128));
                j4 >>>= 7;
            }
            byte[] bArr2 = this.zzb;
            int i5 = this.zzd;
            this.zzd = i5 + 1;
            zzfn.zzp(bArr2, i5, (byte) j4);
            return;
        }
        while ((j4 & (-128)) != 0) {
            try {
    ...
    @Override // com.google.android.gms.internal.icing.zzcm
    public final void zzo(long j4) throws IOException {
        try {
            byte[] bArr = this.zzb;
            int i4 = this.zzd;
            int i5 = i4 + 1;
    ...
    public final void zzp(byte[] bArr, int i4, int i5) throws IOException {
        try {
            ...
            throw new zzcl(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), Integer.valueOf(i5)), e4);
        }
    }

    @Override // com.google.android.gms.internal.icing.zzcm
    public final void zzq(byte[] bArr, int i4, int i5) throws IOException {
        zzp(bArr, 0, i5);
    }
    ...
    public final void zzr(String str) throws IOException {
        ...
        try {
            ...
            if (zzw2 == zzw) {
                int i5 = i4 + zzw2;
                this.zzd = i5;
                int zzd = zzfr.zzd(str, this.zzb, i5, this.zzc - i5);
                this.zzd = i4;
                zzl((zzd - i4) - zzw2);
                this.zzd = zzd;
                return;
            ...
            byte[] bArr = this.zzb;
            int i6 = this.zzd;
            this.zzd = zzfr.zzd(str, bArr, i6, this.zzc - i6);
        } catch (zzfq e4) {
            this.zzd = i4;
            zzD(str, e4);
