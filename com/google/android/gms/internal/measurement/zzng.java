...
public class zzng extends AbstractMap {
    ...
    public final Object zzl(int i4) {
        zzn();
        Object value = ((zzna) this.zzb.remove(i4)).getValue();
        if (!this.zzc.isEmpty()) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (zzb == zzngVar.zzb()) {
            for (int i4 = 0; i4 < zzb; i4++) {
                if (!zzg(i4).equals(zzngVar.zzg(i4))) {
                    return false;
                }
            }
            if (zzb == size) {
    ...
    public final int hashCode() {
        ...
        for (int i5 = 0; i5 < zzb; i5++) {
            i4 += ((zzna) this.zzb.get(i5)).hashCode();
        }
        if (this.zzc.size() > 0) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i5 = this.zza;
        if (size == i5) {
            zzna zznaVar = (zzna) this.zzb.remove(i5 - 1);
            zzm().put(zznaVar.zza(), zznaVar.getValue());
        }
        this.zzb.add(i4, new zzna(this, comparable, obj));
        return null;
    }
