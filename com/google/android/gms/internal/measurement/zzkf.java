...
public final class zzkf extends zzki {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzkf(byte[] bArr, int i4, int i5) {
        super(null);
        if (bArr != null) {
    ...
    public final void zzc(byte[] bArr, int i4, int i5) throws IOException {
        try {
            ...
            throw new zzkg(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zze), Integer.valueOf(this.zzd), Integer.valueOf(i5)), e4);
        }
    }
    ...
    @Override // com.google.android.gms.internal.measurement.zzki
    public final void zze(int i4, zzka zzkaVar) throws IOException {
        zzq((i4 << 3) | 2);
        zzq(zzkaVar.zzd());
        zzkaVar.zzh(this);
    }
    ...
    public final void zzn(String str) throws IOException {
        ...
        try {
            ...
            byte[] bArr = this.zzc;
            int i6 = this.zze;
            this.zze = zznz.zzb(str, bArr, i6, this.zzd - i6);
        } catch (zzny e4) {
            this.zze = i4;
            zzB(str, e4);
    ...
    public final void zzs(long j4) throws IOException {
        ...
        if (z3 && this.zzd - this.zze >= 10) {
            while ((j4 & (-128)) != 0) {
                ...
                int i4 = this.zze;
                this.zze = i4 + 1;
                zznu.zzn(bArr, i4, (byte) ((((int) j4) & 127) | 128));
                j4 >>>= 7;
            }
            byte[] bArr2 = this.zzc;
            int i5 = this.zze;
            this.zze = i5 + 1;
            zznu.zzn(bArr2, i5, (byte) j4);
            return;
        }
        while ((j4 & (-128)) != 0) {
            try {
