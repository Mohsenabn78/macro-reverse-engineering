...
public abstract class zzbi extends zzaq {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Deprecated
    public static int zzt(int i4, zzdf zzdfVar, zzdp zzdpVar) {
    ...
    public static zzbi zzz(byte[] bArr, int i4, int i5) {
        return new zzbf(bArr, 0, i5);
    }
    ...
    public abstract void zze(int i4, zzba zzbaVar) throws IOException;
