...
public final class zzaf extends zzx {
    ...
    private zzaf(@CheckForNull Object obj, Object[] objArr, int i4) {
        this.zzc = obj;
        this.zzb = objArr;
        this.zzd = i4;
    }
    ...
    public static zzaf zzf(int i4, Object[] objArr, zzw zzwVar) {
        int i5;
        short[] sArr;
        Object[] objArr2;
        byte[] bArr;
        ...
        zzm.zzb(i6, objArr3.length >> 1, FirebaseAnalytics.Param.INDEX);
        char c4 = 2;
        ...
        return new zzaf(obj15, objArr3, i6);
    }
