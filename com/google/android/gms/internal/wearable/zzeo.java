...
final class zzeo {
    ...
    public static void zzD(Object obj, long j4, byte b4) {
        long j5 = (-4) & j4;
        zzen zzenVar = zzf;
        int zzj = zzenVar.zzj(obj, j5);
        int i4 = ((~((int) j4)) & 3) << 3;
        zzenVar.zzn(obj, j5, ((255 & b4) << i4) | (zzj & (~(255 << i4))));
    }
    ...
    public static void zzE(Object obj, long j4, byte b4) {
        ...
        zzen zzenVar = zzf;
        int i4 = (((int) j4) & 3) << 3;
        zzenVar.zzn(obj, j5, ((255 & b4) << i4) | (zzenVar.zzj(obj, j5) & (~(255 << i4))));
    }
    ...
    public static /* bridge */ /* synthetic */ boolean zzt(Object obj, long j4) {
        if (((byte) ((zzf.zzj(obj, (-4) & j4) >>> ((int) (((~j4) & 3) << 3))) & 255)) != 0) {
            return true;
        }
        return false;
    }
