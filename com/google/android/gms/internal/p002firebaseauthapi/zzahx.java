...
final class zzahx extends zzafj implements RandomAccess, zzaip {
    private static final zzahx zza = new zzahx(new long[0], 0, false);
    private long[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zzahj.zzd;
        collection.getClass();
        if (!(collection instanceof zzahx)) {
            return super.addAll(collection);
        }
        zzahx zzahxVar = (zzahx) collection;
        int i4 = zzahxVar.zzc;
        if (i4 == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i5 >= i4) {
            ...
            System.arraycopy(zzahxVar.zzb, 0, this.zzb, this.zzc, zzahxVar.zzc);
            this.zzc = i6;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzahxVar.zzc) {
            return false;
        }
        long[] jArr = zzahxVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzahi zzd(int i4) {
        if (i4 >= this.zzc) {
            return new zzahx(Arrays.copyOf(this.zzb, i4), this.zzc, true);
        }
    ...
    private zzahx(long[] jArr, int i4, boolean z3) {
        super(z3);
        this.zzb = jArr;
        this.zzc = i4;
    }
