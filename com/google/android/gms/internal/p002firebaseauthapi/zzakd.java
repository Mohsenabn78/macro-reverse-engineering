...
public final class zzakd {
    ...
    */
    public static int zzb(java.lang.CharSequence r7, byte[] r8, int r9, int r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzakd.zzb(java.lang.CharSequence, byte[], int, int):int");
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static String zzd(byte[] bArr, int i4, int i5) throws zzahl {
        ...
        if ((((length - i4) - i5) | i4 | i5) >= 0) {
            ...
            while (i4 < i6) {
                ...
                if (zzajz.zzd(b5)) {
                    ...
                    if (i8 < i6 - 1) {
                        int i10 = i8 + 1;
                        zzajz.zzb(b5, bArr[i8], bArr[i10], cArr, i7);
                        i4 = i10 + 1;
                        i7++;
                    } else {
                        throw zzahl.zzd();
                    ...
                    byte b7 = bArr[i8];
                    int i12 = i11 + 1;
                    zzajz.zza(b5, b7, bArr[i11], bArr[i12], cArr, i7);
                    i7 += 2;
                    i4 = i12 + 1;
                } else {
                    throw zzahl.zzd();
