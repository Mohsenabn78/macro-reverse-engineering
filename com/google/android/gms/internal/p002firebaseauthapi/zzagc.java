...
public final class zzagc extends zzage {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public /* synthetic */ zzagc(InputStream inputStream, int i4, zzagb zzagbVar) {
        super(null);
    ...
    private final void zzK(int i4) throws IOException {
        if (!zzL(i4)) {
    ...
    private final byte[] zzM(int i4, boolean z3) throws IOException {
        byte[] zzN = zzN(i4);
        if (zzN != null) {
            return zzN;
        }
    ...
    @Override // com.google.android.gms.internal.p002firebaseauthapi.zzage
    ...
    @Override // com.google.android.gms.internal.p002firebaseauthapi.zzage
    public final int zze(int i4) throws zzahl {
        if (i4 >= 0) {
    ...
    */
    public final int zzj() throws java.io.IOException {
        ...
        L6d:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzagc.zzj():int");
    }
    ...
    @Override // com.google.android.gms.internal.p002firebaseauthapi.zzage
    public final zzafy zzw() throws IOException {
        int zzj = zzj();
        int i4 = this.zzg;
        int i5 = this.zzi;
        if (zzj <= i4 - i5 && zzj > 0) {
            zzafy zzn = zzafy.zzn(this.zzf, i5, zzj);
            this.zzi += zzj;
            return zzn;
        } else if (zzj != 0) {
            byte[] zzN = zzN(zzj);
            if (zzN != null) {
                return zzafy.zzn(zzN, 0, zzN.length);
            }
            int i6 = this.zzi;
            int i7 = this.zzg;
            int i8 = i7 - i6;
    ...
    public final String zzx() throws IOException {
        ...
        if (zzj > 0) {
            ...
            int i5 = this.zzi;
            if (zzj <= i4 - i5) {
                String str = new String(this.zzf, i5, zzj, zzahj.zzb);
                this.zzi += zzj;
                return str;
            }
        }
        ...
        if (zzj <= this.zzg) {
            zzK(zzj);
            String str2 = new String(this.zzf, this.zzi, zzj, zzahj.zzb);
            this.zzi += zzj;
            return str2;
        }
        return new String(zzM(zzj, false), zzahj.zzb);
    }
    ...
    public final String zzy() throws IOException {
        ...
        return zzakd.zzd(zzM, i4, zzj);
    }

    @Override // com.google.android.gms.internal.p002firebaseauthapi.zzage
    public final void zzz(int i4) throws zzahl {
        if (this.zzj == i4) {
            return;
        }
        throw zzahl.zzb();
