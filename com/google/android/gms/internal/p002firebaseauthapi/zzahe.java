...
final class zzahe extends zzafj implements RandomAccess, zzaip {
    private static final zzahe zza = new zzahe(new int[0], 0, false);
    private int[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        zzahe zzaheVar = (zzahe) collection;
        int i4 = zzaheVar.zzc;
        if (i4 == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i5 >= i4) {
            ...
            System.arraycopy(zzaheVar.zzb, 0, this.zzb, this.zzc, zzaheVar.zzc);
            this.zzc = i6;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzaheVar.zzc) {
            return false;
        }
        int[] iArr = zzaheVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzahi zzd(int i4) {
        if (i4 >= this.zzc) {
            return new zzahe(Arrays.copyOf(this.zzb, i4), this.zzc, true);
        }
    ...
    private zzahe(int[] iArr, int i4, boolean z3) {
        super(z3);
        this.zzb = iArr;
        this.zzc = i4;
    }
