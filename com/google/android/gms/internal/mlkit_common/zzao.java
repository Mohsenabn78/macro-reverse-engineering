...
public abstract class zzao extends zzak implements List, RandomAccess {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static zzao zzi(Object[] objArr, int i4) {
        if (i4 == 0) {
            return zzau.zza;
        }
        return new zzau(objArr, i4);
    }
    ...
    @Override // java.util.List
    /* renamed from: zzf */
    public zzao subList(int i4, int i5) {
        zzac.zzc(i4, i5, size());
        int i6 = i5 - i4;
        if (i6 == size()) {
            return this;
        ...
        return new zzan(this, i4, i6);
    }

    @Override // java.util.List
    /* renamed from: zzl */
    public final zzbc listIterator(int i4) {
        zzac.zzb(i4, size(), FirebaseAnalytics.Param.INDEX);
        if (isEmpty()) {
            return zza;
        }
        return new zzam(this, i4);
    }
}
