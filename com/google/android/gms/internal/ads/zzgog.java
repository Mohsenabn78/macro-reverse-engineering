...
public final class zzgog extends zzgom {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public /* synthetic */ zzgog(byte[] bArr, int i4, int i5, boolean z3, zzgof zzgofVar) {
        super(null);
    ...
    */
    ...
    public final zzgoe zzw() throws IOException {
        ...
        if (zzj > 0) {
            ...
            int i5 = this.zzh;
            if (zzj <= i4 - i5) {
                zzgoe zzv = zzgoe.zzv(this.zze, i5, zzj);
                this.zzh += zzj;
                return zzv;
            }
        }
        if (zzj != 0) {
            if (zzj > 0) {
                ...
                if (zzj <= i6 - i7) {
                    int i8 = zzj + i7;
                    this.zzh = i8;
                    return new zzgoa(Arrays.copyOfRange(this.zze, i7, i8));
                }
            }
            if (zzj <= 0) {
                throw zzgpy.zzf();
    ...
    public final String zzx() throws IOException {
        ...
        if (zzj > 0) {
            ...
            int i5 = this.zzh;
            if (zzj <= i4 - i5) {
                String str = new String(this.zze, i5, zzj, zzgpw.zzb);
                this.zzh += zzj;
                return str;
            }
        }
    ...
    public final String zzy() throws IOException {
        ...
        if (zzj > 0) {
            ...
            int i5 = this.zzh;
            if (zzj <= i4 - i5) {
                String zzh = zzgsv.zzh(this.zze, i5, zzj);
                this.zzh += zzj;
                return zzh;
            }
        }
