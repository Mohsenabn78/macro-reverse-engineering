...
interface zzgrh {
    ...
    @Deprecated
    void zzC(List list, zzgrp zzgrpVar, zzgoy zzgoyVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzgrp zzgrpVar, zzgoy zzgoyVar) throws IOException;
    ...
    void zzt(Object obj, zzgrp zzgrpVar, zzgoy zzgoyVar) throws IOException;

    void zzu(Object obj, zzgrp zzgrpVar, zzgoy zzgoyVar) throws IOException;
