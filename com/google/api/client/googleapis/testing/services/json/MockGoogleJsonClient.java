...
public class MockGoogleJsonClient extends AbstractGoogleJsonClient {
    ...
    public static class Builder extends AbstractGoogleJsonClient.Builder {
        public Builder(HttpTransport httpTransport, JsonFactory jsonFactory, String str, String str2, HttpRequestInitializer httpRequestInitializer, boolean z3) {
            super(httpTransport, jsonFactory, str, str2, httpRequestInitializer, z3);
        }
    ...
    public MockGoogleJsonClient(HttpTransport httpTransport, JsonFactory jsonFactory, String str, String str2, HttpRequestInitializer httpRequestInitializer, boolean z3) {
        this(new Builder(httpTransport, jsonFactory, str, str2, httpRequestInitializer, z3));
    }
}
