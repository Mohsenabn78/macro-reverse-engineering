...
public final class ArrayListMultimap<K, V> extends ArrayListMultimapGwtSerializationDependencies<K, V> {
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        B(CompactHashMap.u());
        Serialization.e(this, objectInputStream, h4);
    }
    ...
    /* renamed from: F */
    public List<V> t() {
        return new ArrayList(this.f26692h);
    }
    ...
    public static <K, V> ArrayListMultimap<K, V> create(int i4, int i5) {
        return new ArrayListMultimap<>(i4, i5);
    }
    ...
    private ArrayListMultimap(Multimap<? extends K, ? extends V> multimap) {
        this(multimap.keySet().size(), multimap instanceof ArrayListMultimap ? ((ArrayListMultimap) multimap).f26692h : 3);
        putAll(multimap);
    }
}
