...
final class SelectionDialogAction$handleItemSelected$1 extends SuspendLambda implements Function3<CoroutineScope, View, Continuation<? super Unit>, Object> {
    ...
    public SelectionDialogAction$handleItemSelected$1(SelectionDialogAction selectionDialogAction, Spinner spinner, List<String> list, Continuation<? super SelectionDialogAction$handleItemSelected$1> continuation) {
    ...
    public static final void c(final SelectionDialogAction selectionDialogAction, Spinner spinner, List list, MacroDroidVariable macroDroidVariable) {
        ...
        selectionDialogAction.workingsaveIndexVariable = new VariableWithDictionaryKeys(name, new DictionaryKeys(emptyList));
        ...
        VariableHelper.configureNumberVarSpinner(activity, R.style.Theme_App_Dialog_Action, selectionDialogAction, spinner, macro, list, str, "", false, new VariableHelper.VariableSelectedListener() { // from class: com.arlosoft.macrodroid.action.SelectionDialogAction$handleItemSelected$1$1$1
            ...
            public void variableSelected(@NotNull MacroDroidVariable variable, @Nullable List<String> list2) {
                ...
                selectionDialogAction2.workingsaveIndexVariable = new VariableWithDictionaryKeys(name2, new DictionaryKeys(list2));
            }
        });
    }
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable View view, @Nullable Continuation<? super Unit> continuation) {
        return new SelectionDialogAction$handleItemSelected$1(this.this$0, this.$saveIndexSpinner, this.$noneList, continuation).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            VariablesHelper.createNewVariable(activity, spinner, selectionDialogAction, dialogTheme, 1, true, false, new VariablesHelper.VariableCreatedListener() { // from class: com.arlosoft.macrodroid.action.lh
                ...
                public final void variableCreated(MacroDroidVariable macroDroidVariable) {
                    SelectionDialogAction$handleItemSelected$1.c(SelectionDialogAction.this, spinner2, list, macroDroidVariable);
                }
            });
