...
public class OpenWebPageActionInfo extends ActionInfo {
    ...
    private static SelectableItemInfo f3954g;

    public static SelectableItemInfo getInstance() {
        if (f3954g == null) {
            f3954g = new OpenWebPageActionInfo();
        }
        return f3954g;
    }
    ...
    public List<Integer> getAdditionalSearchTerms() {
        ...
        arrayList.add(Integer.valueOf((int) R.string.url));
        return arrayList;
    }
    ...
    public int getHelpInfo() {
        return R.string.action_open_web_page_help;
    }
    ...
    @StringRes
    public int getName() {
        return R.string.action_open_web_page;
    }
}
