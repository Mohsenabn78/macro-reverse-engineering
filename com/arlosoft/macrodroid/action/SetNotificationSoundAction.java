...
public class SetNotificationSoundAction extends Action {
    ...
    /* loaded from: classes2.dex */
    class a implements Parcelable.Creator<SetNotificationSoundAction> {
        a() {
        }
        ...
        @Override // android.os.Parcelable.Creator
        /* renamed from: b */
        public SetNotificationSoundAction[] newArray(int i4) {
            return new SetNotificationSoundAction[i4];
        }
    }
    ...
    public SelectableItemInfo getInfo() {
        return SetNotificationSoundActionInfo.getInstance();
    }

    @Override // com.arlosoft.macrodroid.common.SelectableItem
    public void handleActivityResult(Activity activity, int i4, int i5, Intent intent) {
        if (i4 == REQUEST_CODE_RINGTONE_PICKER && i5 == -1) {
    ...
    public void invokeAction(TriggerContextInfo triggerContextInfo) {
        ...
        if (this.m_ringtoneUri != null) {
            try {
                RingtoneManager.setActualDefaultRingtoneUri(getContext(), 2, Uri.parse(this.m_ringtoneUri));
            } catch (Exception e4) {
            ...
            RingtoneManager.setActualDefaultRingtoneUri(getContext(), 2, null);
        } else {
            ...
            for (int i4 = 0; i4 < ringtoneSounds.size(); i4++) {
                if (ringtoneSounds.get(i4).equals(this.m_ringtoneName)) {
                    ...
                    if (ringtoneUri != null) {
                        try {
                            RingtoneManager.setActualDefaultRingtoneUri(getContext(), 2, ringtoneUri);
                        } catch (Exception e5) {
                            SystemLog.logError("Cannot set ringtone: " + e5.toString(), getMacroGuid().longValue());
                        }
                    } else {
                        SystemLog.logError("Cannot set ringtone, Uri is null", getMacroGuid().longValue());
                    }
                    cursor.close();
                    return;
                }
