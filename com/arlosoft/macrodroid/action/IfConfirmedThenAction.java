...
public final class IfConfirmedThenAction extends IfConditionAction implements SupportsMagicText, BlockingAction {
    ...
    public static final Parcelable.Creator<IfConfirmedThenAction> CREATOR = new Parcelable.Creator<IfConfirmedThenAction>() { // from class: com.arlosoft.macrodroid.action.IfConfirmedThenAction$Companion$CREATOR$1
        ...
        @NotNull
        public IfConfirmedThenAction createFromParcel(@NotNull Parcel parcel) {
        ...
        @Override // android.os.Parcelable.Creator
        @NotNull
        public IfConfirmedThenAction[] newArray(int i4) {
            return new IfConfirmedThenAction[i4];
        }
    };
    ...
    static final class a extends Lambda implements Function7<String, String, String, String, Boolean, Boolean, Integer, Unit> {
        ...
        public final void a(@NotNull String title, @NotNull String text, @NotNull String positiveText, @NotNull String negativeText, boolean z3, boolean z4, int i4) {
            ...
            IfConfirmedThenAction.this.quitOnBackPressed = z3;
            IfConfirmedThenAction.this.cancelAfterTimeout = z4;
            IfConfirmedThenAction.this.timeoutSeconds = i4;
            IfConfirmedThenAction.this.itemComplete();
        }
    ...
    static final class b extends Lambda implements Function0<Unit> {
        ...
        public final void invoke2() {
            IfConfirmedThenAction.this.handleOptionsDialogCancelled();
        }
    }
    ...
    public String getConfiguredName() {
        String r4 = SelectableItem.r(R.string.action_if_confirmed_then);
        Intrinsics.checkNotNullExpressionValue(r4, "getString(R.string.action_if_confirmed_then)");
        return r4;
    }
    ...
    public SelectableItemInfo getInfo() {
        return IfConfirmedThenActionInfo.Companion.getInstance();
    }
    ...
    public void invokeAction(@Nullable TriggerContextInfo triggerContextInfo, int i4, boolean z3, @NotNull Stack<Integer> skipEndifIndexStack, @Nullable ResumeMacroInfo resumeMacroInfo, boolean z4) {
        ...
        Macro macro = getMacro();
        Intrinsics.checkNotNullExpressionValue(macro, "macro");
        ConfirmNextHelperKt.showIfThenConfirmNextDialog(context, macro, triggerContextInfo, this.title, this.text, this.positiveText, this.negativeText, i4, z3, skipEndifIndexStack, resumeMacroInfo, z4, this.quitOnBackPressed, this.cancelAfterTimeout, this.timeoutSeconds);
    }
