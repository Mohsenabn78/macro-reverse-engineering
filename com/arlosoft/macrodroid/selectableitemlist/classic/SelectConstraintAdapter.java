...
public class SelectConstraintAdapter extends SelectableItemAdapter {
    public SelectConstraintAdapter(Activity activity, Macro macro, boolean z3, @NonNull SelectableItemChosenListener selectableItemChosenListener) {
        super(activity, macro, z3, selectableItemChosenListener, 2, false);
        refresh();
    }
