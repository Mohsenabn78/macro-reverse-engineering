...
public class NotificationPresentConstraintInfo extends ConstraintInfo {

    /* renamed from: g  reason: collision with root package name */
    private static SelectableItemInfo f10413g;

    public static SelectableItemInfo getInstance() {
        if (f10413g == null) {
            f10413g = new NotificationPresentConstraintInfo();
        }
        return f10413g;
    }
    ...
    public int getHelpInfo() {
        return R.string.constraint_notification_present_help;
    }
    ...
    @StringRes
    public int getName() {
        return R.string.constraint_notification_present;
    }
