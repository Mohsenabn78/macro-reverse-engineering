...
public class PriorityModeConstraintInfo extends ConstraintInfo {

    /* renamed from: g  reason: collision with root package name */
    private static SelectableItemInfo f10417g;

    public static SelectableItemInfo getInstance() {
        if (f10417g == null) {
            f10417g = new PriorityModeConstraintInfo();
        }
        return f10417g;
    }
    ...
    public int getHelpInfo() {
        return R.string.constraint_priority_mode_help;
    }
    ...
    @StringRes
    public int getName() {
        return R.string.constraint_priority_mode;
    }
