...
public class BrightnessConstraintInfo extends ConstraintInfo {

    /* renamed from: g  reason: collision with root package name */
    private static SelectableItemInfo f10373g;

    public static SelectableItemInfo getInstance() {
        if (f10373g == null) {
            f10373g = new BrightnessConstraintInfo();
        }
        return f10373g;
    }
    ...
    public int getHelpInfo() {
        return R.string.constraint_brightness_help;
    }
