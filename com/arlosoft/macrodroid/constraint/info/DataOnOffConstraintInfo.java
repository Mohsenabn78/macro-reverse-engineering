...
public class DataOnOffConstraintInfo extends ConstraintInfo {

    /* renamed from: g  reason: collision with root package name */
    private static SelectableItemInfo f10380g;

    public static SelectableItemInfo getInstance() {
        if (f10380g == null) {
            f10380g = new DataOnOffConstraintInfo();
        }
        return f10380g;
    }
    ...
    public int getHelpInfo() {
        return R.string.constraint_data_on_off_help;
    }
    ...
    @StringRes
    public int getName() {
        return R.string.constraint_data_on_off;
    }
}
