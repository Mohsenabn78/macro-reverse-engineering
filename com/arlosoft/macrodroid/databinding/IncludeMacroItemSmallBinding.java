...
public final class IncludeMacroItemSmallBinding implements ViewBinding {
    @NonNull
    ...
    @NonNull
    public static IncludeMacroItemSmallBinding bind(@NonNull View view) {
                                                    ...
                                                    if (textView5 != null) {
                                                        ...
                                                        if (imageView4 != null) {
                                                            ...
                                                            if (findChildViewById3 != null) {
                                                                ...
                                                                if (frameLayout != null) {
                                                                    return new IncludeMacroItemSmallBinding(constraintLayout, imageView, linearLayout, linearLayout2, findChildViewById, imageView2, textView, textView2, textView3, findChildViewById2, imageView3, textView4, textView5, imageView4, findChildViewById3, constraintLayout, frameLayout);
                                                                }
                                                            }
                                                        }
                                                    }
    ...
    @NonNull
    public static IncludeMacroItemSmallBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static IncludeMacroItemSmallBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
        View inflate = layoutInflater.inflate(R.layout.include_macro_item_small, viewGroup, false);
        if (z3) {
