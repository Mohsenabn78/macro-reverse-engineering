...
public final class IncludeMacroItemBinding implements ViewBinding {
    @NonNull
    ...
    @NonNull
    public static IncludeMacroItemBinding bind(@NonNull View view) {
                                                        ...
                                                        if (textView5 != null) {
                                                            ...
                                                            if (imageView4 != null) {
                                                                ...
                                                                if (findChildViewById4 != null) {
                                                                    ...
                                                                    if (frameLayout != null) {
                                                                        return new IncludeMacroItemBinding(constraintLayout, imageView, linearLayout, linearLayout2, findChildViewById, imageView2, findChildViewById2, textView, textView2, textView3, findChildViewById3, imageView3, textView4, textView5, imageView4, findChildViewById4, constraintLayout, frameLayout);
                                                                    }
                                                                }
                                                            }
                                                        }
    ...
    @NonNull
    public static IncludeMacroItemBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static IncludeMacroItemBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
        View inflate = layoutInflater.inflate(R.layout.include_macro_item, viewGroup, false);
        if (z3) {
