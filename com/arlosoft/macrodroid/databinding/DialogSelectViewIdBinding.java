...
public final class DialogSelectViewIdBinding implements ViewBinding {
    ...
    private final LinearLayout f11122a;
    @NonNull
    ...
    private DialogSelectViewIdBinding(@NonNull LinearLayout linearLayout, @NonNull RadioButton radioButton, @NonNull CheckBox checkBox, @NonNull Button button, @NonNull RadioButton radioButton2, @NonNull AppCompatEditText appCompatEditText, @NonNull TextView textView) {
        this.f11122a = linearLayout;
    ...
    @NonNull
    public static DialogSelectViewIdBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
