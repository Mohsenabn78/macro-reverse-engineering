...
public final class MacroEditEntryLegacyBinding implements ViewBinding {
    @NonNull
    ...
    private MacroEditEntryLegacyBinding(@NonNull ConstraintLayout constraintLayout, @NonNull ImageView imageView, @NonNull LinearLayout linearLayout, @NonNull LinearLayout linearLayout2, @NonNull View view, @NonNull ImageView imageView2, @NonNull View view2, @NonNull TextView textView, @NonNull TextView textView2, @NonNull TextView textView3, @NonNull View view3, @NonNull ImageView imageView3, @NonNull TextView textView4, @NonNull TextView textView5, @NonNull ImageView imageView4, @NonNull View view4, @NonNull ConstraintLayout constraintLayout2, @NonNull FrameLayout frameLayout) {
        ...
        this.macroEditEntryExtrasJoiner = view3;
        ...
        this.startSpacing = view4;
        this.topLevelContainer = constraintLayout2;
        this.topLevelExtrasContainer = frameLayout;
    }

    @NonNull
    public static MacroEditEntryLegacyBinding bind(@NonNull View view) {
            ...
            if (linearLayout != null) {
                ...
                if (linearLayout2 != null) {
                    ...
                    if (findChildViewById != null) {
                        ...
                        if (imageView2 != null) {
                            i4 = R.id.hairline;
                            View findChildViewById2 = ViewBindings.findChildViewById(view, R.id.hairline);
                                ...
                                if (textView != null) {
                                    ...
                                    if (textView2 != null) {
                                        ...
                                        if (textView3 != null) {
                                            ...
                                            View findChildViewById3 = ViewBindings.findChildViewById(view, R.id.macro_edit_entry_extras_joiner);
                                                    ...
                                                    if (textView4 != null) {
                                                        ...
                                                        if (textView5 != null) {
                                                            ...
                                                            if (imageView4 != null) {
                                                                ...
                                                                View findChildViewById4 = ViewBindings.findChildViewById(view, R.id.start_spacing);
                                                                if (findChildViewById4 != null) {
                                                                    ...
                                                                    if (frameLayout != null) {
                                                                        return new MacroEditEntryLegacyBinding(constraintLayout, imageView, linearLayout, linearLayout2, findChildViewById, imageView2, findChildViewById2, textView, textView2, textView3, findChildViewById3, imageView3, textView4, textView5, imageView4, findChildViewById4, constraintLayout, frameLayout);
                                                                    }
                                                                }
                                                            }
                                                        }
    ...
    @NonNull
    public static MacroEditEntryLegacyBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static MacroEditEntryLegacyBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
        View inflate = layoutInflater.inflate(R.layout.macro_edit_entry_legacy, viewGroup, false);
        if (z3) {
