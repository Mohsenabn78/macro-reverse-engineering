...
public final class CommentsDataSource extends ItemKeyedDataSource<Long, Comment> {
    public static final int $stable = 8;
    @NotNull

    /* renamed from: a  reason: collision with root package name */
    private final TemplateStoreApi f13760a;
    @NotNull

    /* renamed from: b  reason: collision with root package name */
    private final CompositeDisposable f13761b;
    ...
    private MutableLiveData<LoadState> f13763d;
    ...
    static final class a extends Lambda implements Function1<Flowable<Throwable>, Publisher<?>> {
        ...
        /* compiled from: pluginCommentsDataSource.kt */
        /* renamed from: com.arlosoft.macrodroid.templatestore.ui.comments.data.CommentsDataSource$a$a  reason: collision with other inner class name */
        /* loaded from: classes3.dex */
        public static final class C0118a extends Lambda implements Function1<Throwable, Publisher<? extends Long>> {

            /* renamed from: d  reason: collision with root package name */
            public static final C0118a f13765d = new C0118a();
        ...
        public final Publisher<?> invoke(@NotNull Flowable<Throwable> errors) {
            ...
            final C0118a c0118a = C0118a.f13765d;
            return errors.flatMap(new Function() { // from class: com.arlosoft.macrodroid.templatestore.ui.comments.data.e
                @Override // io.reactivex.functions.Function
                public final Object apply(Object obj) {
                    Publisher c4;
                    c4 = CommentsDataSource.a.c(Function1.this, obj);
                    return c4;
                }
            });
        }
    ...
    static final class c extends Lambda implements Function1<Flowable<Throwable>, Publisher<?>> {
        ...
        public static final class a extends Lambda implements Function1<Throwable, Publisher<? extends Long>> {
            ...
            /* renamed from: d  reason: collision with root package name */
            public static final a f13767d = new a();
        ...
        public final Publisher<?> invoke(@NotNull Flowable<Throwable> errors) {
            Intrinsics.checkNotNullParameter(errors, "errors");
            final a aVar = a.f13767d;
            return errors.flatMap(new Function() { // from class: com.arlosoft.macrodroid.templatestore.ui.comments.data.f
                @Override // io.reactivex.functions.Function
                public final Object apply(Object obj) {
                    Publisher c4;
                    c4 = CommentsDataSource.c.c(Function1.this, obj);
                    return c4;
                }
            });
        }
    ...
    static final class d extends Lambda implements Function1<List<? extends Comment>, Unit> {
        ...
        final /* synthetic */ CommentsDataSource this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        d(ItemKeyedDataSource.LoadInitialCallback<Comment> loadInitialCallback, CommentsDataSource commentsDataSource) {
            super(1);
            this.$callback = loadInitialCallback;
            this.this$0 = commentsDataSource;
        }
    ...
    public CommentsDataSource(@NotNull TemplateStoreApi api, @NotNull CompositeDisposable compositeDisposable, int i4) {
        Intrinsics.checkNotNullParameter(api, "api");
        Intrinsics.checkNotNullParameter(compositeDisposable, "compositeDisposable");
        this.f13760a = api;
        this.f13761b = compositeDisposable;
        this.f13762c = i4;
    ...
    public final void i(LoadState loadState) {
        this.f13763d.postValue(loadState);
    }
    ...
    public void loadAfter(@NotNull ItemKeyedDataSource.LoadParams<Long> params, @NotNull ItemKeyedDataSource.LoadCallback<Comment> callback) {
        ...
        CompositeDisposable compositeDisposable = this.f13761b;
        Single<List<Comment>> comments = this.f13760a.getComments(this.f13762c, params.key.longValue(), params.requestedLoadSize);
        final a aVar = a.f13764d;
        Single<List<Comment>> retryWhen = comments.retryWhen(new Function() { // from class: com.arlosoft.macrodroid.templatestore.ui.comments.data.c
            @Override // io.reactivex.functions.Function
            public final Object apply(Object obj) {
                Publisher e4;
                e4 = CommentsDataSource.e(Function1.this, obj);
                return e4;
            }
        });
        final b bVar = new b(callback);
        compositeDisposable.add(retryWhen.subscribe(new Consumer() { // from class: com.arlosoft.macrodroid.templatestore.ui.comments.data.d
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                CommentsDataSource.f(Function1.this, obj);
            }
        }));
    }
    ...
    public void loadInitial(@NotNull ItemKeyedDataSource.LoadInitialParams<Long> params, @NotNull ItemKeyedDataSource.LoadInitialCallback<Comment> callback) {
        ...
        i(LoadState.LOADING);
        CompositeDisposable compositeDisposable = this.f13761b;
        Single<List<Comment>> comments = this.f13760a.getComments(this.f13762c, Long.MAX_VALUE, params.requestedLoadSize);
        final c cVar = c.f13766d;
        Single<List<Comment>> retryWhen = comments.retryWhen(new Function() { // from class: com.arlosoft.macrodroid.templatestore.ui.comments.data.a
            @Override // io.reactivex.functions.Function
            public final Object apply(Object obj) {
                Publisher g4;
                g4 = CommentsDataSource.g(Function1.this, obj);
                return g4;
            }
        });
        final d dVar = new d(callback, this);
        compositeDisposable.add(retryWhen.subscribe(new Consumer() { // from class: com.arlosoft.macrodroid.templatestore.ui.comments.data.b
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                CommentsDataSource.h(Function1.this, obj);
            }
        }));
    }
