...
public final class MainTextMatchedSubstringsItem {
    ...
    @NotNull
    public static /* synthetic */ MainTextMatchedSubstringsItem copy$default(MainTextMatchedSubstringsItem mainTextMatchedSubstringsItem, Integer num, Integer num2, int i4, Object obj) {
        if ((i4 & 1) != 0) {
    ...
    @NotNull
    public final MainTextMatchedSubstringsItem copy(@Nullable Integer num, @Nullable Integer num2) {
    ...
    public boolean equals(@Nullable Object obj) {
        if (this != obj) {
            if (obj instanceof MainTextMatchedSubstringsItem) {
                ...
                if (!Intrinsics.areEqual(this.offset, mainTextMatchedSubstringsItem.offset) || !Intrinsics.areEqual(this.length, mainTextMatchedSubstringsItem.length)) {
                    return false;
                }
                return true;
            }
    ...
    public MainTextMatchedSubstringsItem(@Nullable Integer num, @Nullable Integer num2) {
        this.offset = num;
        this.length = num2;
    }

    public /* synthetic */ MainTextMatchedSubstringsItem(Integer num, Integer num2, int i4, DefaultConstructorMarker defaultConstructorMarker) {
