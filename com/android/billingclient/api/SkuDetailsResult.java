...
public final class SkuDetailsResult {
    ...
    public SkuDetailsResult(@RecentlyNonNull BillingResult billingResult, @RecentlyNonNull @Nullable List<? extends SkuDetails> list) {
    ...
    @RecentlyNonNull
    public static /* synthetic */ SkuDetailsResult copy$default(@RecentlyNonNull SkuDetailsResult skuDetailsResult, @RecentlyNonNull BillingResult billingResult, @RecentlyNonNull List list, int i4, @RecentlyNonNull Object obj) {
        if ((i4 & 1) != 0) {
    ...
    @NotNull
    public final SkuDetailsResult copy(@RecentlyNonNull BillingResult billingResult, @RecentlyNonNull @Nullable List<? extends SkuDetails> list) {
        Intrinsics.checkNotNullParameter(billingResult, "billingResult");
    ...
    public boolean equals(@RecentlyNonNull @Nullable Object obj) {
        ...
        if (Intrinsics.areEqual(this.zza, skuDetailsResult.zza) && Intrinsics.areEqual(this.zzb, skuDetailsResult.zzb)) {
            return true;
        }
        return false;
    }
