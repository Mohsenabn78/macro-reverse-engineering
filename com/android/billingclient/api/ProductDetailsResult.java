...
public final class ProductDetailsResult {
    ...
    @RecentlyNonNull
    public static /* synthetic */ ProductDetailsResult copy$default(@RecentlyNonNull ProductDetailsResult productDetailsResult, @RecentlyNonNull BillingResult billingResult, @RecentlyNonNull List list, int i4, @RecentlyNonNull Object obj) {
        if ((i4 & 1) != 0) {
    ...
    @NotNull
    public final ProductDetailsResult copy(@RecentlyNonNull BillingResult billingResult, @RecentlyNonNull @Nullable List<ProductDetails> list) {
        Intrinsics.checkNotNullParameter(billingResult, "billingResult");
    ...
    public boolean equals(@RecentlyNonNull @Nullable Object obj) {
        ...
        if (Intrinsics.areEqual(this.zza, productDetailsResult.zza) && Intrinsics.areEqual(this.zzb, productDetailsResult.zzb)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        List list = this.zzb;
        return "ProductDetailsResult(billingResult=" + billingResult + ", productDetailsList=" + list + ")";
    }
}
