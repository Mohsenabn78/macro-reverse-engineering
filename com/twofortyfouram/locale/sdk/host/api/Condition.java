...
public final class Condition {
    ...
    public Condition(@NonNull Context context, @NonNull Plugin plugin) {
        HandlerThread newHandlerThread = ThreadUtil.newHandlerThread(Condition.class.getName(), ThreadUtil.ThreadPriority.BACKGROUND);
    ...
    public Pair<Integer, Bundle> query(@NonNull PluginInstanceData pluginInstanceData, int i4) {
        Assertions.assertNotNull(pluginInstanceData, "data");
        Assertions.assertInRangeInclusive(i4, 16, 18, "previousState");
        try {
            return query(BundleSerializer.deserializeFromByteArray(pluginInstanceData.getSerializedBundle()), i4);
        } catch (Exception e4) {
    ...
    private Pair<Integer, Bundle> query(@NonNull Bundle bundle, int i4) {
