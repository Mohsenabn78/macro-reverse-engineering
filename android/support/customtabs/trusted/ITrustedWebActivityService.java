...
public interface ITrustedWebActivityService extends IInterface {
    public static final String DESCRIPTOR = "android$support$customtabs$trusted$ITrustedWebActivityService".replace((char) Typography.dollar, '.');
    ...
    public static abstract class Stub extends Binder implements ITrustedWebActivityService {
        ...
        public static class a implements ITrustedWebActivityService {
            ...
            public Bundle areNotificationsEnabled(Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    this.f192a.transact(6, obtain, obtain2, 0);
            ...
            public Bundle extraCommand(String str, Bundle bundle, IBinder iBinder) throws RemoteException {
                ...
                try {
                    ...
                    this.f192a.transact(9, obtain, obtain2, 0);
                    obtain2.readException();
                    return (Bundle) _Parcel.c(obtain2, Bundle.CREATOR);
                } finally {
                    obtain2.recycle();
            ...
            public Bundle getSmallIconBitmap() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(ITrustedWebActivityService.DESCRIPTOR);
                    this.f192a.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
                    return (Bundle) _Parcel.c(obtain2, Bundle.CREATOR);
                } finally {
                    obtain2.recycle();
        ...
        public boolean onTransact(int i4, Parcel parcel, Parcel parcel2, int i5) throws RemoteException {
            ...
            switch (i4) {
                case 2:
                    Bundle notifyNotificationWithChannel = notifyNotificationWithChannel((Bundle) _Parcel.c(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    _Parcel.d(parcel2, notifyNotificationWithChannel, 1);
                    break;
                case 3:
                    cancelNotification((Bundle) _Parcel.c(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    break;
                case 4:
                ...
                case 5:
                    ...
                    parcel2.writeNoException();
                    _Parcel.d(parcel2, activeNotifications, 1);
                    break;
                case 6:
                    Bundle areNotificationsEnabled = areNotificationsEnabled((Bundle) _Parcel.c(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    _Parcel.d(parcel2, areNotificationsEnabled, 1);
                    break;
                case 7:
                    Bundle smallIconBitmap = getSmallIconBitmap();
                    parcel2.writeNoException();
                    _Parcel.d(parcel2, smallIconBitmap, 1);
                    break;
                case 8:
                default:
                    return super.onTransact(i4, parcel, parcel2, i5);
                case 9:
                    Bundle extraCommand = extraCommand(parcel.readString(), (Bundle) _Parcel.c(parcel, Bundle.CREATOR), parcel.readStrongBinder());
                    parcel2.writeNoException();
                    _Parcel.d(parcel2, extraCommand, 1);
                    break;
            }
            return true;
        }
